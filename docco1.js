...
(function() {
  ...
  parse = function(source, code, config) {
    var badCodeText, docsText, goodCodeText, hasCode, i, isText, lang, line, lines, match, maybeCode, save, sections, _i, _j, _len, _len1;
    if (config == null) {
      config = {};
    }
    lines = code.split('\n');
    ...
    save = function() {
      sections.push({
        ...
        goodCodeText: goodCodeText
      });
      return hasCode = docsText = badCodeText = goodCodeText = '';
    };
    if (lang.literate) {
  ...
  format = function(source, sections, config) {
    var badcode, goodcode, i, language, section, _i, _len, _results;
    ...
    for (i = _i = 0, _len = sections.length; _i < _len; i = ++_i) {
      ...
      section.codeHtml = ("<div class='highlight badcode'><pre>" + badcode + "</pre></div>") + ("<div class='highlight goodcode'><pre>" + goodcode + "</pre></div>");
